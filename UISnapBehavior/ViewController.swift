...
class CustomAlertView: UIViewController {
    ...
    func createAlert() {
        ...
        buttonOk.setImage(UIImage(named: "ok.png"), for: UIControlState())
        ...
        buttonOk.addTarget(self, action: #selector(CustomAlertView.ok), for: UIControlEvents.touchUpInside)
        
        let buttonCancel = UIButton(type: .custom)
        buttonCancel.setImage(UIImage(named: "cancel.jpeg"), for: UIControlState())
        buttonCancel.layer.cornerRadius = buttonWidth/2
...
//        buttonCancel.addTarget(self, action: #selector(CustomAlertView.dismissAlert), for: UIControlEvents.touchUpInside)
        buttonCancel.addTarget(self, action: #selector(CustomAlertView.cacel), for: UIControlEvents.touchUpInside)
